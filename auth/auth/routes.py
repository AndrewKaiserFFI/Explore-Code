# auth/routes.py
"""
Auth blueprint: self-signup, login, logout.
Gates access to drift reports / remediation views via @login_required
...
def signup():
    ...
    if form.validate_on_submit():
        ...
        # First registered user is bootstrapped as admin; all subsequent
        # self-signups default to viewer. Admins can promote others later.
